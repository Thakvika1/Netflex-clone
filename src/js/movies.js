    ...
    .then(() => {
      ...
      const setOpenById = (button) => {
        button.addEventListener("click", () => {
          const modalImgAttribute = modal.querySelector(".modal-thumbnail-img img");
          const modalLogo = document.getElementById('modal-movie-logo');
          modalLogo.setAttribute('src', 'https://occ-0-64-58.1.nflxso.net/dnm/api/v6/LmEnxtiAuzezXBjYXPuDgfZ4zZQ/AAAABSBsAhmR0aJ6bimiDhIYJ4mDFraFlpo9SY_SUqepVfzC2XHyHvy_gXWPYJiYHZ3EHONsH9MaORlDH_7k-IUIcxX_oxcsL8RlPhbJ8Ud7_FJk.webp?r=e29')
          modalImgAttribute.setAttribute(
            "src",
            'https://occ-0-64-58.1.nflxso.net/dnm/api/v6/6AYY37jfdO6hpXcMjf9Yu5cnmO0/AAAABQw43IRRmuoAyJCaWVZyiZ854dNir58hyj72yff2mXKPgB-lWdlmBi93r7XI7W93RumOXkIhCXQ2Zu2rRdZOmXb9D31UKntzLS1d.webp?r=7f1'
          );
