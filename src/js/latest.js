function shuffleArray(array) {
  ...
  document.addEventListener('DOMContentLoaded', () => {
    ...
    .then(data => {
        ...
        <div class="carousel-progress-container">
          <div class="genre-title">
            <div class="title-name">New on Netflix</div>
    ...
    .then(data => {
        ...
        <div class="carousel-progress-container">
          <div class="genre-title">
            <div class="title-name">Coming Next Week</div>
            <div class="sliding-indicator">Explore all</div>
            <div class="sliding-arrow">
              <svg viewBox="0 0 16 31" fill="none" xmlns="http://www.w3.org/2000/svg">
                <path
    ...
    .then(data => {
        ...
        <div class="carousel-progress-container">
          <div class="genre-title">
            <div class="title-name">Coming This month</div>
            <div class="sliding-indicator">Explore all</div>
            <div class="sliding-arrow">
              <svg viewBox="0 0 16 31" fill="none" xmlns="http://www.w3.org/2000/svg">
                <path
    ...
    .then(data => {
        ...
        <div class="carousel-progress-container">
          <div class="genre-title">
            <div class="title-name">Coming This Week</div>
            <div class="sliding-indicator">Explore all</div>
            <div class="sliding-arrow">
              <svg viewBox="0 0 16 31" fill="none" xmlns="http://www.w3.org/2000/svg">
                <path
