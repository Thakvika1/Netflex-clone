    ...
    .then(() => {
      ...
      const setOpenById = (button) => {
        button.addEventListener("click", () => {
          const modalImgAttribute = modal.querySelector(".modal-thumbnail-img img");
          const modalLogo = document.getElementById('modal-movie-logo');
          modalLogo.setAttribute('src', 'https://occ-0-64-58.1.nflxso.net/dnm/api/v6/LmEnxtiAuzezXBjYXPuDgfZ4zZQ/AAAABXV3JDQz-dLtCSEAma33wKiaRHSKa2ExDCqBP_TpH_u8rEp1VmlL4p-UUeKj1JqAQd5GjEXhtR3zhzrWVAL9KWbCU1lUELk2A-Isc9pP7l-Q_h0xvq3R96GShIpYcFN6F4mezVp91WjL8IEJ1VP9kAisCcMlsdFs-J9Z6_hwcr19BB3I3nwEwA.webp?r=9bc')
          modalImgAttribute.setAttribute(
            "src",
            'https://occ-0-64-58.1.nflxso.net/dnm/api/v6/6AYY37jfdO6hpXcMjf9Yu5cnmO0/AAAABbThfBYk1Af85wRVUxZinkhhqP-mRZp9Hqa6nGm3AIxddm5YpOmIdzEpVJlP1RjaSGzY909P_qBRfnDHZc5uXLc-EilrPwvHudNR.webp?r=66b'
          );
